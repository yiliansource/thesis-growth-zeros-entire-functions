...
% Furthermore, $\rho_f < \infty$ if and only if $M_f(r) = O(\exp(r^{\rho_f + \varepsilon}))$ for every $\varepsilon > 0$ and no $\varepsilon < 0$, as $r \to \infty$~\cite{segal-complex-analysis}.
