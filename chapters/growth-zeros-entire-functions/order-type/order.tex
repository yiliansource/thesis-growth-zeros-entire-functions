...
From \Cref{prop:order-infimum}, together with some rough estimates, it follows that the order of the sum or product of two entire functions is bounded by above the larger of the two:
