...
\begin{proof}
    That the order of the sum or product is bounded above by the higher of the respective two orders is immediately obtained through \Cref{prop:order-infimum}.
