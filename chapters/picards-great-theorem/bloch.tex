...
\begin{proof}
    ...
    Set $t \coloneqq \frac{1}{2}(1 - \vert p \vert) > 0$, then for $z \in B_{t}(p)$ we have $B_{t}(p) \subseteq \D$ and $1 - \vert z \vert \geq t$. Since $\vert f'(z) \vert (1 - \vert z \vert) \leq C_f = 2 t \vert f'(p) \vert$, this implies $\vert f'(z) \vert \leq 2 \vert f'(p) \vert$. By \Cref{lem:bloch-lemma-2}, we obtain
...
In the following we will denote by $\beta > 0$ any constant satisfying Bloch's Theorem (\ref{thm:bloch}), for example $\beta = \frac{1}{12}$.
