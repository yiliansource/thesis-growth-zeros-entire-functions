\documentclass[a4paper,11pt,bibliography=totoc,listof=totoc,headinclude=true,open=right]{scrbook}
...
\newcommand{\deriv}[2]{\frac{\mathrm{d}^{#2}}{\mathrm{d} {#1}^{#2}}}
...
\setlist[arrowlist]{label=$\rightsquigarrow$}
...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \vskip 8mm
    {\huge\bfseries\setstretch{1.1} Picard's Great Theorem \\ \vspace{-0.1cm}{\Large and} \\ Growth, Zeros, and Composition \\ of Entire Functions \par}
    \vskip 1cm
    \large 
    ausgef\"uhrt am    
    \vskip 0.75cm
